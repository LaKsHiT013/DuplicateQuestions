...
def main():
    ...
    st.write("Welcome! This tool uses machine learning to determine if two questions are duplicates. Simply enter the questions below and click 'Find'.")

    # Create columns for better layout
    col1, col2 = st.columns(2)

    with col1:
        q1 = st.text_area("Enter Question 1", key="text1", height=100, help="Enter the first question you want to compare.")
    
    with col2:
        q2 = st.text_area("Enter Question 2", key="text2", height=100, help="Enter the second question you want to compare.")
